...
if __name__ == '__main__':
    #创建保存模型的文件夹
    file_dir = 'checkpoints/resnet50_v3'
    ...
    dataset_train = datasets.ImageFolder("/home/itaer2/zxy/shixi/project_1/Baseline model validation for VF progression prediction/Data_eye/train", transform=transform)
    dataset_test = datasets.ImageFolder("/home/itaer2/zxy/shixi/project_1/Baseline model validation for VF progression prediction/Data_eye/val", transform=transform_test)
