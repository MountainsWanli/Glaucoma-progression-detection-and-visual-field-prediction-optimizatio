...
if __name__ == '__main__':
    ...
    file_dir = 'checkpoints/resTrans_annogan'
    ...
    # Load data
    dataset_train = datasets.ImageFolder('/home/itaer2/zxy/shixi/project_1/Baseline model validation for VF progression prediction/Data_eye_Annotated/train', transform=transform)
    dataset_test = datasets.ImageFolder('/home/itaer2/zxy/shixi/project_1/Baseline model validation for VF progression prediction/Data_eye_Annotated/val', transform=transform_test)
