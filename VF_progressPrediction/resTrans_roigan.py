...
if __name__ == '__main__':
    ...
    file_dir = 'checkpoints/resTrans_roigan'
    ...
    # Load data
    dataset_train = datasets.ImageFolder('/home/itaer2/zxy/shixi/project_1/Baseline model validation for VF progression prediction/Data_eye_ROI_v2/train', transform=transform)
    dataset_test = datasets.ImageFolder("/home/itaer2/zxy/shixi/project_1/Baseline model validation for VF progression prediction/Data_eye_ROI_v2/val", transform=transform_test)
